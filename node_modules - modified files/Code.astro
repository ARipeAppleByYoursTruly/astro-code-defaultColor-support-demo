...
// Search for `// Aa` using Ctrl + F

// There are 3 line additions in this file
...
interface Props extends Omit<HTMLAttributes<'pre'>, 'lang'> {
   ...
   * Aa
   *
   * Controls the default theme to style with, uses keys defined in "themes" option.
   * To remove the default theme styling and only style using CSS variables, set this to `false`.
   *
   * See https://shiki.matsu.io/guide/dual-themes#without-default-color for more information.
   *
   * @default "light"
   */
  defaultColor?: string | false // Aa
	/**
